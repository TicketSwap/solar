...
export const color = {
  ...
  titanFocusAlpha: 'var(--titanFocusAlpha)',
  ...
  marsFocusAlpha: 'var(--marsFocusAlpha)',
  ...
  sunFocusAlpha: 'var(--sunFocusAlpha)',

  facebook: 'var(--facebook)',
  facebookLight: 'var(--facebookLight)',
  facebookFocusAlpha: 'var(--facebookFocusAlpha)',

  twitter: 'var(--twitter)',
  twitterLight: 'var(--twitterLight)',
  twitterFocusAlpha: 'var(--twitterFocusAlpha)',

  whatsapp: 'var(--whatsapp)',
  whatsappFocusAlpha: 'var(--whatsappFocusAlpha)',
}
