...
export interface StyledInputMenuProps extends InputMenuProps {
  heightOfMenu: number
}

const StyledInputMenu = styled.div<StyledInputMenuProps>`
  text-align: left;
  position: absolute;
  left: 0;
  right: 0;
...
export const InputMenu = ({ children, ...props }: InputMenuProps) => {
