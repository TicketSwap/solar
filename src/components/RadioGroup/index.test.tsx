...
const RadioExample = () => {
  ...
  return <Radio value={value} id="test" name="test" checked onChange={() => setValue('test')} />
}
...
describe('Radio', () => {
  it('renders without crashing', () => {
    render(<Radio onChange={() => null} value="on" checked id="test" name="test" />)
...
describe('RadioGroup', () => {
  ...
  describe('with options', () => {
    it('has a list of radio buttons', () => {
      ...
      expect(screen.getByRole('radio', { name: /checkmark rob/i })).toBeInTheDocument()
      expect(screen.getByRole('radio', { name: /checkmark bob/i })).toBeInTheDocument()
    })
    ...
    describe('and one of them is clicked', () => {
      it('checks the selected option', () => {
        ...
        expect(screen.getByRole('radio', { name: /checkmark rob/i })).toBeChecked()
        expect(screen.getByRole('radio', { name: /checkmark bob/i })).not.toBeChecked()
      })
    })
    ...
    describe('and the other option is clicked', () => {
      it('checks the other option', () => {
        ...
        expect(screen.getByRole('radio', { name: /checkmark bob/i })).toBeChecked()
        expect(screen.getByRole('radio', { name: /checkmark rob/i })).not.toBeChecked()
      })
    })
  })
})
