...
const IconWrapper: React.FC<IconWrapperProps> = ({ icon, name }) => {
  ...
  return (
    <IconBlock>
      ...
      >
        {copied ? <Icon.Checkmark size={12} /> : <Icon.Copy title="Copy name" size={12} />}
      </CopyButton>
    </IconBlock>
  )
}
...
export const Icons = () => {
  return (
    <IconGrid>
      ...
      <IconWrapper icon={<Icon.AlertRounded title="AlertRounded" />} name="AlertRounded" />
      <IconWrapper icon={<Icon.Android title="Android" />} name="Android" />
      <IconWrapper icon={<Icon.Apple title="Apple" />} name="Apple" />
      <IconWrapper icon={<Icon.ArrowDown title="ArrowDown" />} name="ArrowDown" />
      <IconWrapper
        icon={<Icon.ArrowDownRounded title="ArrowDownRounded" />}
        name="ArrowDownRounded"
      />
      <IconWrapper icon={<Icon.ArrowUpRounded title="ArrowUpRounded" />} name="ArrowUpRounded" />
      ...
      <IconWrapper icon={<Icon.CalendarClock title="CalendarClock" />} name="CalendarClock" />
      <IconWrapper icon={<Icon.CalendarDay title="CalendarDay" />} name="CalendarDay" />
      <IconWrapper icon={<Icon.CalendarWeekend title="CalendarWeekend" />} name="CalendarWeekend" />
      <IconWrapper icon={<Icon.Cart title="Cart" />} name="Cart" />
      <IconWrapper icon={<Icon.Chat title="Chat" />} name="Chat" />
      <IconWrapper icon={<Icon.Checkmark title="Checkmark" />} name="Checkmark" />
      <IconWrapper
        icon={<Icon.CheckmarkRounded title="CheckmarkRounded" />}
        name="CheckmarkRounded"
      />
      <IconWrapper icon={<Icon.ChevronDown title="ChevronDown" />} name="ChevronDown" />
      <IconWrapper icon={<Icon.ChevronDownAlt title="ChevronDownAlt" />} name="ChevronDownAlt" />
      <IconWrapper icon={<Icon.ChevronLeft title="ChevronLeft" />} name="ChevronLeft" />
      <IconWrapper icon={<Icon.ChevronLeftAlt title="ChevronLeftAlt" />} name="ChevronLeftAlt" />
      <IconWrapper icon={<Icon.ChevronRight title="ChevronRight" />} name="ChevronRight" />
      <IconWrapper icon={<Icon.ChevronRightAlt title="ChevronRightAlt" />} name="ChevronRightAlt" />
      <IconWrapper icon={<Icon.ChevronUp title="ChevronUp" />} name="ChevronUp" />
      <IconWrapper icon={<Icon.ChevronUpAlt title="ChevronUpAlt" />} name="ChevronUpAlt" />
      ...
      <IconWrapper icon={<Icon.CloseRounded title="CloseRounded" />} name="CloseRounded" />
      ...
      <IconWrapper icon={<Icon.CreditCard title="CreditCard" />} name="CreditCard" />
      ...
      <IconWrapper icon={<Icon.EventType title="EventType" />} name="EventType" />
      ...
      <IconWrapper icon={<Icon.InfoRounded title="InfoRounded" />} name="InfoRounded" />
      <IconWrapper icon={<Icon.Instagram title="Instagram" />} name="Instagram" />
      ...
      <IconWrapper icon={<Icon.Loudspeaker title="Loudspeaker" />} name="Loudspeaker" />
      <IconWrapper icon={<Icon.MagnifyingGlass title="MagnifyingGlass" />} name="MagnifyingGlass" />
      <IconWrapper
      ...
      <IconWrapper icon={<Icon.Messenger title="Messenger" />} name="Messenger" />
      <IconWrapper icon={<Icon.Minus title="Minus" />} name="Minus" />
      <IconWrapper icon={<Icon.MinusAlt title="MinusAlt" />} name="MinusAlt" />
      <IconWrapper icon={<Icon.MinusRounded title="MinusRounded" />} name="MinusRounded" />
      <IconWrapper icon={<Icon.MobilePhone title="MobilePhone" />} name="MobilePhone" />
      <IconWrapper icon={<Icon.Money title="Money" />} name="Money" />
      <IconWrapper icon={<Icon.MusicalNote title="MusicalNote" />} name="MusicalNote" />
      <IconWrapper icon={<Icon.Padlock title="Padlock" />} name="Padlock" />
      <IconWrapper icon={<Icon.Paperclip title="Paperclip" />} name="Paperclip" />
      ...
      <IconWrapper icon={<Icon.PhoneVerified title="PhoneVerified" />} name="PhoneVerified" />
      ...
      <IconWrapper icon={<Icon.PlusRounded title="PlusRounded" />} name="PlusRounded" />
      <IconWrapper icon={<Icon.QrCode title="QrCode" />} name="QrCode" />
      <IconWrapper icon={<Icon.Questionmark title="Questionmark" />} name="Questionmark" />
      <IconWrapper
      ...
      <IconWrapper icon={<Icon.SellTicket title="SellTicket" />} name="SellTicket" />
      ...
      <IconWrapper icon={<Icon.SoundCloud title="SoundCloud" />} name="SoundCloud" />
      ...
      <IconWrapper icon={<Icon.ThumbsDown title="ThumbsDown" />} name="ThumbsDown" />
      <IconWrapper icon={<Icon.ThumbsUp title="ThumbsUp" />} name="ThumbsUp" />
      <IconWrapper icon={<Icon.Ticket title="Ticket" />} name="Ticket" />
      <IconWrapper icon={<Icon.TicketSwap title="TicketSwap" />} name="TicketSwap" />
      ...
      <IconWrapper icon={<Icon.WarningRounded title="WarningRounded" />} name="WarningRounded" />
      <IconWrapper icon={<Icon.Watch title="Watch" />} name="Watch" />
      <IconWrapper icon={<Icon.WhatsApp title="WhatsApp" />} name="WhatsApp" />
      <IconWrapper icon={<Icon.ExternalLink title="ExternalLink" />} name="ExternalLink" />
    </IconGrid>
  )
}
